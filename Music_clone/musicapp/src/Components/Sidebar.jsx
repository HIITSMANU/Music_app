...
const Sidebar = () => {
  return (
    <div className='w-[25%] h-full p-2 flex-col text-white hidden lg:flex'>
      ...
      <div className="bg-[#121212] h-[85%] rounded gap-3">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start pl-4 gap-1">
            <h1>Let's Find Some Broadcast to Follow</h1>
            <p className='font-light'>We will keep you updated</p>
            <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Browse Broadcasts</button>
        </div>
      </div>
    </div>
  )
